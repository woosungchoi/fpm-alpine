...
Status: **started conservatively on maintained branches**
...
- [x] Normalize `ENV LD_PRELOAD=...` syntax to current Dockerfile style where branch form allows a low-risk replacement
